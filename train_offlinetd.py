...
from dataloader import get_sequential_dataloader, get_batch_dataloader, get_batch_dataloader_bugged_but_fast
...
train_dataloaders = get_batch_dataloader_bugged_but_fast(train_data,
                                         batch_size=args['batch_size'],
                                         num_workers=args['nthreads'],
                                         shuffle=args['shuffle'])
train_dataloaders_non_shuffled = get_batch_dataloader_bugged_but_fast(train_data,
                                                      batch_size=args['batch_size'],
                                                      num_workers=args['nthreads'],
                                                      shuffle=False,
                                                      drop_last=False)
val_dataloaders = get_batch_dataloader_bugged_but_fast(val_data,
                                       batch_size=args['batch_size'],
                                       num_workers=args['nthreads'],
                                       shuffle=False,
                                       drop_last=False)
